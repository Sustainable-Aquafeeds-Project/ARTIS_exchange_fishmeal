...
# %>%  # remove fishing area because ARTIS is only resolved to country level information
#   filter(str_detect(country, "Iceland"))
...
test2 <- read.csv(here("int/material_origins_skretting_global.csv"))
```
