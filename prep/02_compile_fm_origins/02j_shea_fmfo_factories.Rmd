...
tidy_df <- raw_df %>%
  ...
  add_row(factory_id = 188, country = "Mauritania", common_name = "sardine", sciname = "sardinella", aquaculture = "no", wholefish = "yes", trimmings = "no", data_source_feed = "Shea et al. 2025", data_source_fao_area_country = NA, feed_report_spp_name = "sardine", trash_fish = "no", capture = "yes", source_country_iso3c = "MRT") %>%
    add_row(factory_id = 193, common_name = "sardine", sciname = "sardinella", aquaculture = "no", wholefish = "yes", trimmings = "no", data_source_feed = "Shea et al. 2025", data_source_fao_area_country = NA, feed_report_spp_name = "sardine", trash_fish = "no", capture = "yes", source_country_iso3c = "MRT", country = "Mauritania") %>%
      add_row(factory_id = 207, common_name = "sardine", sciname = "sardinella", aquaculture = "no", wholefish = "yes", trimmings = "no", data_source_feed = "Shea et al. 2025", data_source_fao_area_country = NA, feed_report_spp_name = "sardine", trash_fish = "no", capture = "yes", source_country_iso3c = "MRT", country = "Mauritania") %>%
      add_row(factory_id = 217, common_name = "sardine", sciname = "sardinella", aquaculture = "no", wholefish = "yes", trimmings = "no", data_source_feed = "Shea et al. 2025", data_source_fao_area_country = NA, feed_report_spp_name = "sardine", trash_fish = "no", capture = "yes", source_country_iso3c = "MRT", country = "Mauritania") %>%
      add_row(factory_id = 224, common_name = "sardine", sciname = "sardinella", aquaculture = "no", wholefish = "yes", trimmings = "no", data_source_feed = "Shea et al. 2025", data_source_fao_area_country = NA, feed_report_spp_name = "sardine", trash_fish = "no", capture = "yes", source_country_iso3c = "MRT", country = "Mauritania")
