...
fix_arg <- fao_fisheries_df %>%
  ...
  # group_by(factory_id, source_country_iso3c, country, common_name, aquaculture, wholefish, trimmings, data_source_feed, data_source_fao_area_country, trash_fish, capture, sciname) %>%
