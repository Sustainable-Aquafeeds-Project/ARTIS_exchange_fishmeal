...
sum(extra_trimmings_2013$unused_trimmings_t, na.rm = TRUE) # 2171396; pretty close; after accounting for what we already use. And it would make sense that a more current year would have less unused trimmings, since apparently there has been uptake in trimmings use. 
